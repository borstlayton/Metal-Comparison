...
df_2000 = pd.read_csv(CSV_FILE_2000, skiprows=[1,2])
df_2025 = pd.read_csv(CSV_FILE_2025, skiprows=[1,2])

# Load units row - commented out as not used currently
# units_2000 = pd.read_csv(CSV_FILE_2000).iloc[0].to_dict()
# units_2025 = pd.read_csv(CSV_FILE_2025).iloc[0].to_dict()
